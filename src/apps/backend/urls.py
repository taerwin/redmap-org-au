...
urlpatterns = patterns('backend',
                       ...
                       url(r'^sightings/past/$',
                           MySightingList.as_view(), name="sightings_past"),
                       url(r'^sightings/all/$', AllSightingsList.as_view(),
                           name="sightings_list"),
                       url(r'^sightings/edit/(?P<pk>\d+)/$',
                           SightingEdit, name='sighting_edit'),
                       url(r'^sightings/delete/(?P<pk>\d+)/$', SightingDelete,
                           name='sighting_delete'),
                       url(
                           r'^sightings/reassign/(?P<pk>\d+)/$', SightingReassign,
                       name='sighting_reassign'),
                       url(r'^sightings/spam/(?P<pk>\d+)/$',
                           SightingSpam, name='sighting_spam'),

                       url(r'^experts/assignments/$', manage_experts.as_view(),
                           name='manage_experts'),

                       url(r'^experts/assignments/add/$',
                           AddSpeciesExpert, name='add_expert'),

                       url(
                           r'^experts/assignments/edit/(?P<pk>\d+)/$', AddSpeciesExpert,
                       name='edit_expert'),
                       ...
                       url(
                           r'^experts/allocations/$', AdministratorAllocations.as_view(),
                       name='administrator_allocations'),
                       url(
                           r'^experts/allocations/add/$', AdministratorAllocationEdit,
                       ...
                       url(
                           r'^experts/rules/edit/(?P<pk>\d+)/$', edit_validation_rule,
                       name='edit_validation_rule'),
                       url(
                           r'^experts/rules/delete/(?P<pk>\d+)/$', delete_validation_rule,
                       ...
                       url(
                           r'^experts/templates/edit/(?P<pk>\d+)/$', AddEmailTemplate,
                       ...
                       url(
                           r'^experts/conditions/add/$', ValidationConditionAdd,
                       ...
                       url(r'^admin/members/$',
                           MemberIndex.as_view(), name="member_index"),
                       url(r'^admin/members/add/$',
                           MemberAdd, name='member_add'),
                       url(r'^admin/members/edit/(?P<pk>\d+)/$',
                           MemberAdd, name='member_edit'),
                       url(
                           r'^admin/members/delete/(?P<pk>\d+)/$', MemberDelete,
                       name='member_delete'),
                       url(
                           r'^admin/members/resend-activation/(?P<user_id>\d+)/$',
                       resend_member_activation, name='member_resend_activation'),

                       url(r'^admin/scientists/$', ScientistIndex.as_view(),
                           name='scientist_index'),
                       url(r'^admin/scientists/add/$',
                           AddScientist, name='add_scientist'),
                       url(
                           r'^admin/scientists/delete/(?P<pk>\d+)/$', DeleteScientist,
                       name='delete_scientist'),

                       url(
                           r'^admin/administrators/$', RegionalAdministrators.as_view(),
                       name='regional_administrators'),
                       url(
                           r'^admin/administrators/add/$', RegionalAdministratorAdd,
                       ...
                       url(
                           r'^admin/organisations/$', OrganisationIndex.as_view(),
