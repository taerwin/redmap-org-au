...
urlpatterns = patterns(
    ...
    url(r'^region/(?P<region_slug>[\w-]+)/$', region_landing_page,
    ...
    url(r'^region/(?P<region_slug>[\w-]+)/resources/(?P<slug>.*)/$',
    ...
    url(r'^region/(?P<region_slug>[\w-]+)/news/$',
        FrontendNews.as_view(), name="region_zinnia_entry_archive_index"),
    ...
    url(r'^sightings/(?P<pk>\d+)/$', SightingDetailView.as_view(),
